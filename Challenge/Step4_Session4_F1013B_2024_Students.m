%%%%%%%%%%%%%%%%%%%%%%
%Step4_Session4_F1013B
%%%%%%%%%%%%%%%%%%%%%%


%TO-DO%

% (1) After closing (ending) the while loop, and before the ending the blood cell for loop, introduce the following counter. 
...
% (2) Finally, after ending the blood cell for loop, add the final stats
% calculations, and describe each line.
...
for ery=1:?
    ...
    % --Initialize the erythrocyte position and velocities--
     ...
     while ? > ?
         ...
         %Follow professor's directions in the whiteborad to complete this part. There will be extra points,
         %stay attentive! :)

         end

         % Calculate the new position of the erythrocyte assuming mass=1
         
         %delete(head) code part should be here
